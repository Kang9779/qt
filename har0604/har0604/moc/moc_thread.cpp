...
**
** Created: Mon Jun 4 16:04:19 2018
...
static const char qt_meta_stringdata_Thread[] = {
    "Thread\0\0warn_signal()\0warnFun_slot()\0"
};
...
static const char qt_meta_stringdata_Thread2[] = {
    "Thread2\0\0warn_signal()\0warnFun_slot()\0"
};
...
// SIGNAL 0
void Thread2::warn_signal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}
static const uint qt_meta_data_ThreadBack[] = {
...
static const char qt_meta_stringdata_ThreadBack[] = {
    "ThreadBack\0\0settingpara1(char*)\0"
    "settingpara2(char*)\0array\0set_arr(QByteArray)\0"
    "can_return()\0bArray\0canTest(QByteArray)\0"
};

void ThreadBack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ThreadBack *_t = static_cast<ThreadBack *>(_o);
        switch (_id) {
        case 0: _t->settingpara1((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 1: _t->settingpara2((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 2: _t->set_arr((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 3: _t->can_return(); break;
        case 4: _t->canTest((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ThreadBack::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ThreadBack::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadBack,
      qt_meta_data_ThreadBack, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ThreadBack::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *ThreadBack::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *ThreadBack::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThreadBack))
        return static_cast<void*>(const_cast< ThreadBack*>(this));
    return QThread::qt_metacast(_clname);
}

int ThreadBack::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void ThreadBack::settingpara1(char * _t1)
{
...
// SIGNAL 1
void ThreadBack::settingpara2(char * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ThreadBack::set_arr(QByteArray _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
