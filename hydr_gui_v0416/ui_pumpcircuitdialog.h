/********************************************************************************
** Form generated from reading UI file 'pumpcircuitdialog.ui'
**
...
#ifndef UI_PUMPCIRCUITDIALOG_H
#define UI_PUMPCIRCUITDIALOG_H
...
class Ui_PumpCircuitDialog
{
public:
    QLabel *labelImagePump;
    QWidget *panel;
    ...
    void setupUi(QDialog *PumpCircuitDialog)
    {
        if (PumpCircuitDialog->objectName().isEmpty())
            PumpCircuitDialog->setObjectName(QStringLiteral("PumpCircuitDialog"));
        PumpCircuitDialog->resize(1000, 750);
        PumpCircuitDialog->setStyleSheet(QString::fromUtf8("QDialog\n"
"{\n"
...
"	border-image:url(:/icons/rsc/double-left-chevron.png)\n"
"}"));
        labelImagePump = new QLabel(PumpCircuitDialog);
        labelImagePump->setObjectName(QStringLiteral("labelImagePump"));
        labelImagePump->setEnabled(true);
        labelImagePump->setGeometry(QRect(20, 50, 461, 361));
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(labelImagePump->sizePolicy().hasHeightForWidth());
        labelImagePump->setSizePolicy(sizePolicy);
        labelImagePump->setMinimumSize(QSize(0, 0));
        labelImagePump->setPixmap(QPixmap(QString::fromUtf8(":/images/rsc/pumpCircuit.tif")));
        labelImagePump->setScaledContents(true);
        panel = new QWidget(PumpCircuitDialog);
        ...
        figureListWidget = new QListWidget(PumpCircuitDialog);
        ...
        stackedWidget = new QStackedWidget(PumpCircuitDialog);
...
"border-right-color: rgb(0, 0, 0);"));
        ...
        horizontalWidget_2 = new QWidget(PumpCircuitDialog);
        ...
        groupEval = new QGroupBox(PumpCircuitDialog);
        ...
        horizontalWidget = new QWidget(PumpCircuitDialog);
        ...
        imagePressure2 = new QLabel(PumpCircuitDialog);
        imagePressure2->setObjectName(QStringLiteral("imagePressure2"));
        imagePressure2->setGeometry(QRect(287, 60, 61, 41));
        ...
        imagePressure3 = new QLabel(PumpCircuitDialog);
        imagePressure3->setObjectName(QStringLiteral("imagePressure3"));
        imagePressure3->setGeometry(QRect(119, 84, 61, 41));
        ...
        imagePressure1 = new QLabel(PumpCircuitDialog);
        imagePressure1->setObjectName(QStringLiteral("imagePressure1"));
        imagePressure1->setGeometry(QRect(167, 60, 61, 41));
        ...
        retranslateUi(PumpCircuitDialog);

        stackedWidget->setCurrentIndex(1);


        QMetaObject::connectSlotsByName(PumpCircuitDialog);
    } // setupUi

    void retranslateUi(QDialog *PumpCircuitDialog)
    {
        PumpCircuitDialog->setWindowTitle(QApplication::translate("PumpCircuitDialog", "Dialog", Q_NULLPTR));
        labelImagePump->setText(QString());
        label_6->setText(QApplication::translate("PumpCircuitDialog", "\346\266\262\345\216\213\346\263\265\345\233\236\350\267\257", Q_NULLPTR));
        pageDown_1->setText(QString());
        label_7->setText(QApplication::translate("PumpCircuitDialog", "\351\241\271\347\233\256", Q_NULLPTR));
        label_8->setText(QApplication::translate("PumpCircuitDialog", "\344\270\212\346\254\241\346\243\200\346\265\213\346\227\266\351\227\264", Q_NULLPTR));
        label_9->setText(QApplication::translate("PumpCircuitDialog", "\346\225\205\351\232\234", Q_NULLPTR));
        label_10->setText(QApplication::translate("PumpCircuitDialog", "\350\211\257\345\245\275", Q_NULLPTR));
        label_11->setText(QApplication::translate("PumpCircuitDialog", "\345\276\205\346\243\200", Q_NULLPTR));
        label_4->setText(QApplication::translate("PumpCircuitDialog", "\344\270\213\344\270\200\346\255\245", Q_NULLPTR));
        pageDown_2->setText(QString());
        pageUp_2->setText(QString());
        label_12->setText(QApplication::translate("PumpCircuitDialog", "\344\270\212\344\270\200\346\255\245", Q_NULLPTR));
        label_13->setText(QApplication::translate("PumpCircuitDialog", "\344\270\213\344\270\200\346\255\245", Q_NULLPTR));
        btnRun->setText(QString());
        btnStop->setText(QString());
        btnHistory->setText(QString());
        btnEval->setText(QString());
        pageUp_3->setText(QString());
        label_14->setText(QApplication::translate("PumpCircuitDialog", "\344\270\212\344\270\200\346\255\245", Q_NULLPTR));
        label->setText(QApplication::translate("PumpCircuitDialog", "\345\201\245\345\272\267\350\257\204\344\274\260", Q_NULLPTR));
        groupEval->setTitle(QString());
        labelSeosor->setText(QApplication::translate("PumpCircuitDialog", "\345\233\236\350\267\257\351\242\204\346\243\200", Q_NULLPTR));
...
namespace Ui {
    class PumpCircuitDialog: public Ui_PumpCircuitDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PUMPCIRCUITDIALOG_H
