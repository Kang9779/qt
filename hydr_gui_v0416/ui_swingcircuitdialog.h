/********************************************************************************
** Form generated from reading UI file 'swingcircuitdialog.ui'
**
...
#ifndef UI_SWINGCIRCUITDIALOG_H
#define UI_SWINGCIRCUITDIALOG_H
...
public:
    ...
    void setupUi(QDialog *SwingCircuitDialog)
    {
        if (SwingCircuitDialog->objectName().isEmpty())
            SwingCircuitDialog->setObjectName(QStringLiteral("SwingCircuitDialog"));
        SwingCircuitDialog->resize(1000, 750);
        SwingCircuitDialog->setStyleSheet(QString::fromUtf8("QDialog\n"
"{\n"
...
"	border-image:url(:/icons/rsc/double-left-chevron.png)\n"
"}"));
        panel = new QWidget(SwingCircuitDialog);
        ...
        figureListWidget = new QListWidget(SwingCircuitDialog);
        ...
        frame = new QFrame(SwingCircuitDialog);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(20, 50, 461, 361));
        frame->setStyleSheet(QStringLiteral(""));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        labelImageSwing = new QLabel(frame);
        labelImageSwing->setObjectName(QStringLiteral("labelImageSwing"));
        labelImageSwing->setGeometry(QRect(0, 0, 461, 358));
        sizePolicy.setHeightForWidth(labelImageSwing->sizePolicy().hasHeightForWidth());
        labelImageSwing->setSizePolicy(sizePolicy);
        labelImageSwing->setMinimumSize(QSize(292, 358));
        labelImageSwing->setPixmap(QPixmap(QString::fromUtf8(":/circuit/rsc/\345\233\236\350\275\254\347\263\273\347\273\237\345\216\237\347\220\206\345\233\276\346\227\240\346\241\206.gif")));
        labelImageSwing->setScaledContents(true);
        imagePressure3 = new QLabel(frame);
        imagePressure3->setObjectName(QStringLiteral("imagePressure3"));
        imagePressure3->setGeometry(QRect(213, 310, 61, 41));
        sizePolicy.setHeightForWidth(imagePressure3->sizePolicy().hasHeightForWidth());
        imagePressure3->setSizePolicy(sizePolicy);
        imagePressure3->setPixmap(QPixmap(QString::fromUtf8(":/transducer/rsc/pressure_right.png")));
        imagePressure2 = new QLabel(frame);
        imagePressure2->setObjectName(QStringLiteral("imagePressure2"));
        imagePressure2->setGeometry(QRect(288, 126, 61, 41));
        ...
        imageDisp = new QLabel(frame);
        imageDisp->setObjectName(QStringLiteral("imageDisp"));
        imageDisp->setGeometry(QRect(160, 70, 51, 16));
        ...
        imageDisp->setPixmap(QPixmap(QString::fromUtf8(":/transducer/rsc/disp_right.png")));
        imageDisp->setScaledContents(true);
        imagePressure1 = new QLabel(frame);
        imagePressure1->setObjectName(QStringLiteral("imagePressure1"));
        imagePressure1->setGeometry(QRect(85, 126, 71, 41));
        ...
        imagePressure4 = new QLabel(frame);
        imagePressure4->setObjectName(QStringLiteral("imagePressure4"));
        imagePressure4->setGeometry(QRect(110, 310, 61, 41));
        ...
        stackedWidget = new QStackedWidget(SwingCircuitDialog);
...
"border-right-color: rgb(0, 0, 0);"));
        ...
        groupEval = new QGroupBox(SwingCircuitDialog);
        ...
        horizontalWidget_2 = new QWidget(SwingCircuitDialog);
        ...
        horizontalWidget = new QWidget(SwingCircuitDialog);
        ...
        retranslateUi(SwingCircuitDialog);

        stackedWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(SwingCircuitDialog);
    } // setupUi

    void retranslateUi(QDialog *SwingCircuitDialog)
    {
        SwingCircuitDialog->setWindowTitle(QApplication::translate("SwingCircuitDialog", "Dialog", Q_NULLPTR));
        label_6->setText(QApplication::translate("SwingCircuitDialog", "\345\233\236\350\275\254\346\266\262\345\216\213\345\233\236\350\267\257", Q_NULLPTR));
        labelImageSwing->setText(QString());
        ...
        label_7->setText(QApplication::translate("SwingCircuitDialog", "\351\241\271\347\233\256", Q_NULLPTR));
        label_8->setText(QApplication::translate("SwingCircuitDialog", "\344\270\212\346\254\241\346\243\200\346\265\213\346\227\266\351\227\264", Q_NULLPTR));
        label_9->setText(QApplication::translate("SwingCircuitDialog", "\346\225\205\351\232\234", Q_NULLPTR));
        label_10->setText(QApplication::translate("SwingCircuitDialog", "\350\211\257\345\245\275", Q_NULLPTR));
        label_11->setText(QApplication::translate("SwingCircuitDialog", "\345\276\205\346\243\200", Q_NULLPTR));
        label_4->setText(QApplication::translate("SwingCircuitDialog", "\344\270\213\344\270\200\346\255\245", Q_NULLPTR));
        pressureSensor1->setText(QString());
        label_2->setText(QApplication::translate("SwingCircuitDialog", "\344\274\240\346\204\237\345\231\250\344\277\241\345\217\267\347\261\273\345\236\213\357\274\232 ", Q_NULLPTR));
        pressureSensor2->setText(QString());
        label_3->setText(QApplication::translate("SwingCircuitDialog", "\344\274\240\346\204\237\345\231\250\344\277\241\345\217\267\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        dispSensor->setText(QString());
        label_5->setText(QApplication::translate("SwingCircuitDialog", "\344\274\240\346\204\237\345\231\250\344\277\241\345\217\267\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        pressureSensor3->setText(QString());
        label_16->setText(QApplication::translate("SwingCircuitDialog", "\344\274\240\346\204\237\345\231\250\344\277\241\345\217\267\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        pressureSensor4->setText(QString());
        label_17->setText(QApplication::translate("SwingCircuitDialog", "\344\274\240\346\204\237\345\231\250\344\277\241\345\217\267\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        pageDown_2->setText(QString());
        pageUp_2->setText(QString());
        label_12->setText(QApplication::translate("SwingCircuitDialog", "\344\270\212\344\270\200\346\255\245", Q_NULLPTR));
        label_13->setText(QApplication::translate("SwingCircuitDialog", "\344\270\213\344\270\200\346\255\245", Q_NULLPTR));
        btnRun->setText(QString());
        btnStop->setText(QString());
        btnHistory->setText(QString());
        btnEval->setText(QString());
        pageUp_3->setText(QString());
        label_14->setText(QApplication::translate("SwingCircuitDialog", "\344\270\212\344\270\200\346\255\245", Q_NULLPTR));
        groupEval->setTitle(QString());
        label->setText(QApplication::translate("SwingCircuitDialog", "\345\201\245\345\272\267\350\257\204\344\274\260", Q_NULLPTR));
        labelSeosor->setText(QApplication::translate("SwingCircuitDialog", "\345\233\236\350\267\257\351\242\204\346\243\200", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class SwingCircuitDialog: public Ui_SwingCircuitDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SWINGCIRCUITDIALOG_H
